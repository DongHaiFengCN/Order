...
public class CustomTitleBar extends LinearLayout {
    ...
    public CustomTitleBar(Context context, AttributeSet attrs) {
        ...
        title_textSize = typedArray.getColor(R.styleable.CustomTitleBar_title_textSize, 26);
        /**返回按钮相关*/
        left_button_imageId = typedArray.getResourceId(R.styleable.CustomTitleBar_left_button_image, R.drawable.animback);
        ...
        /**右边保存按钮相关*/
        right_button_imageId = typedArray.getResourceId(R.styleable.CustomTitleBar_right_button_image, R.drawable.animadd);
    ...
    public void setLeft_button_imageId(int left_button_imageId) {
       // left_button.setBackgroundResource(left_button_imageId);
        left_button.setImageResource(left_button_imageId);
      //  left_button.set(left_button_imageId);
    }
    ...
    public void setRight_button_imageId(int right_button_imageId) {
       // right_button.setBackgroundResource(right_button_imageId);
        right_button.setImageResource(right_button_imageId);
    }
