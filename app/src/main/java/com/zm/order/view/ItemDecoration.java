...
public class ItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public ItemDecoration(Context context, ArrayList<OrderBean> dataList, OnDecorationCallback onDecorationCallback) {
        ...
        mPaint = new Paint();
        mPaint.setColor(resources.getColor(R.color.md_black_1000));
